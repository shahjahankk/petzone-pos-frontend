    ...
    <Card sx={{
      ...
      <CardContent sx={{ p: 1.5, '&:last-child': { pb: 1.5 }, overflow: 'visible' }}>
        <Box sx={{ display: 'flex', gap: 1, alignItems: 'center', width: '100%' }}>
          ...
          <Box sx={{ flex: 5, minWidth: 0, position: 'relative' }}>
          ...
          {/* SKU is auto-generated by the backend — no manual entry on create/edit PO */}
          {/*
    ...
    <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
      ...
      />
        ...
        <Dialog open={formDialogOpen} onClose={() => setFormDialogOpen(false)} maxWidth={false} fullWidth PaperProps={dialogPaperProps}>
          ...
          <DialogContent sx={{ pt: 3, pb: 2, overflow: 'hidden', display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
            <Box sx={{ overflowY: 'auto', overflowX: 'visible', flex: 1, minHeight: 520 }}>
              {submitError && (
